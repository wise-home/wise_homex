defmodule WiseHomex.ApiClientBehaviour do
  ...
  @callback get_admin_messages(Config.t(), query) :: response
  ...
  @callback import_keepfocus_devices(Config.t(), attributes, relationships) :: response
  ...
  @callback delete_measurements_for_device(Config.t(), id, attributes) :: response
  @callback delete_utility_readings_for_device(Config.t(), id, attributes) :: response
  ...
  @callback get_custom_statement_job(Config.t(), id, query) :: response
